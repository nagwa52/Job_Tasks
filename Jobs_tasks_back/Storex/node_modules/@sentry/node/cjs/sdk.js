...
var console = require('./integrations/console.js');
var http = require('./integrations/http.js');
var onuncaughtexception = require('./integrations/onuncaughtexception.js');
var onunhandledrejection = require('./integrations/onunhandledrejection.js');
var contextlines = require('./integrations/contextlines.js');
var context = require('./integrations/context.js');
var modules = require('./integrations/modules.js');
var linkederrors = require('./integrations/linkederrors.js');
var http$1 = require('./transports/http.js');
...
function init(options = {}) {
  ...
  if ((domain ).active) {
    hub.setHubOnCarrier(carrier, core.getCurrentHub());
  }
